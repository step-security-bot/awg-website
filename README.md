![GitHub package.json version](https://img.shields.io/github/package-json/v/webern-unibas-ch/awg-ng-website.svg)
[![GitHub package.json dependency version (prod)](https://img.shields.io/github/package-json/dependency-version/webern-unibas-ch/awg-ng-website/@angular/core?color=blue&label=angular&logo=angular)](https://github.com/angular/angular)
![Node.js version](https://img.shields.io/badge/node.js-%3E=v18.19.0-blue)
![GitHub commit activity](https://img.shields.io/github/commit-activity/m/webern-unibas-ch/awg-ng-website)
![CI Workflow](https://github.com/webern-unibas-ch/awg-ng-website/actions/workflows/ci_workflow.yml/badge.svg)
[![OpenSSF Scorecard](https://api.scorecard.dev/projects/github.com/webern-unibas-ch/awg-ng-website/badge)](https://scorecard.dev/viewer/?uri=github.com/webern-unibas-ch/awg-ng-website)
