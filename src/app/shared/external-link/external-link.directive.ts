...
import { Directive, HostBinding, Inject, OnChanges, PLATFORM_ID, input } from '@angular/core';
...
export class ExternalLinkDirective implements OnChanges {
    ...
    private _isExternalLink() {
        return (
            isPlatformBrowser(this.platformId) && !this.href().includes(location.hostname) && !this._isLanguageCode()
        );
    }
